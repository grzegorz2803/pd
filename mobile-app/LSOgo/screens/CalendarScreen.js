...
export default function CalendarScreen({route}){
    ...
    const weekDays = Array.from({ length: 6 }, (_, i) => {
        ...
        return {
          ...
          date: `${date.getDate()} ${date.toLocaleDateString('pl-PL', { month: 'long' })} ${date.getFullYear()}`,
        };
      });
          ...
          <ImageBackground
            ...
            <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContainer}>
                <View style={styles.cardToday}>
                    <Image source={require('../assets/cross.png')} style={styles.crossDay} />
            ...
            {!loggedIn && (
                <View style={styles.bottomNav}>
                    ...
                    <TouchableOpacity style={styles.navItem}>
                    <Image source={require('../assets/contact.png')} style={styles.navIcon} />
