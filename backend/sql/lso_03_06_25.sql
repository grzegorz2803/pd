...
--
-- Host: localhost
-- Generation Time: Cze 03, 2025 at 04:33 PM
...
(5, '292340078623', 'marek.now', '$2b$10$nbHkcKbhJHQ07xuRsb5DMesl7BElt1OfSthLTF5wB/pC0WNrB3tzG', 'listwan94@gmail.com', 'user', 'ministrant', 1, 1, '2025-05-20 14:49:26'),
...
(11, '88040314991', 'pawel.zie', '$2b$10$8S5UwGt/DpElfU99RfKvMODOh.Dr/vspPF619WaRUv.4ITW.YBBDy', '', 'moderator', 'lektor', 0, 0, '2025-05-20 14:53:35');
...
--
-- Struktura tabeli dla tabeli `lso_schedules`
--

CREATE TABLE `lso_schedules` (
  `id` int(11) NOT NULL,
  `user_card_id` varchar(50) NOT NULL,
...
--
-- Dumping data for table `lso_schedules`
--

INSERT INTO `lso_schedules` (`id`, `user_card_id`, `day_of_week`, `time`, `created_at`, `updated_at`, `week_number`) VALUES
(4, '1050529798272', 'Poniedziałek', '18:00:00', '2025-05-29 12:02:41', '2025-05-29 12:02:41', 22),
(5, '1050529798272', 'Czwartek', '07:00:00', '2025-05-29 12:02:41', '2025-05-29 12:02:41', 22),
(6, '1050529798272', 'Niedziela', '09:30:00', '2025-05-29 12:02:41', '2025-05-29 12:02:41', 22);
...
(31, '1050529798272', '4ad03765530440246a575ad01384f8254f77fb72cee3ab35c9cc66380916e7f0', '2025-06-16 19:08:49', '2025-06-02 19:08:49', 'mobile', NULL, NULL);
...
--
-- Indeksy dla tabeli `lso_schedules`
--
ALTER TABLE `lso_schedules`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `lso_schedules`
--
ALTER TABLE `lso_schedules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
-- Constraints for table `lso_schedules`
--
ALTER TABLE `lso_schedules`
  ADD CONSTRAINT `lso_schedules_ibfk_1` FOREIGN KEY (`user_card_id`) REFERENCES `users` (`card_id`) ON DELETE CASCADE;
